    ...
    render() {
        ...
        return (
            <div className="col-md-6 col-md-offset-3">
                <h2>Nạp tiền vào tài khoản</h2> <br/>
                <form name="form" onSubmit={(e) => this.handleSubmit(e)}>
                    ...
                    <div className='form-group'>
                        <label htmlFor="add_money">Số tiền muốn nạp</label>
                        <input type="text" pattern="[0-9]*" className="form-control" name="add_money" value={add_money} onChange={(e) => this.handleChangeNumber(e)} />
                        {submitted && !add_money &&
                            <div className="help-block">Số tiền muốn nạp không được để trống</div>
                        }
                    </div>
                    <div className="form-group">
                        <button className="btn btn-primary">Cập nhật tài khoản</button>
                        {signingIn &&
